...
'anoxia_summer', 'secchi_max', 'secchi_min', 'zoopDensity'))
  ...
  om_time <- seqdist(seq, method = "OM", indel = 1, sm = scost)
  ...
  sequencePlots[[2]] / 
    ...
    sequencePlots[[9]] /
    sequencePlots[[10]] /
    sequencePlots[[11]] +  plot_layout(guides = 'collect')
  ggsave(filename = 'Figures/sequencePlot.png', dpi = 300, width = 7, height = 18)
